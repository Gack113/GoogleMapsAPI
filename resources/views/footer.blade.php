			...
			<div class="row">
				<div class="col-sm-4">
					<div class="widget">
						...
						<div>
							<ul>
								<li><a href="{{route('home')}}"><i class="fa fa-chevron-right"></i> Bánh Âu</a></li>
								<li><a href="{{route('home')}}"><i class="fa fa-chevron-right"></i> Thơm Ngon</a></li>
						...
						<div>
							<div class="contact-info">
								<a href="{{route('lien-he')}}">
									...
									<p>21, Lê Lợi, Phường 4, Quận Gò Vấp, TP.HCM</p>
								</a>
							</div>
							<br><br>
							<div class="contact-info">
				...
				<div class="col-sm-4">
					<div class="widget">
						<h4 class="widget-title">Để lại thông tin để được tư vấn</h4>
